...
yt = r'bin/youtube-dl-2018.07.21'
...
class AsyncYoutube:
    ...
    def __init__(self, urls_file=None):
        ...
        self.path = os.path.split(self.script)[0]
        self.d = self.path + r'/files/downloading'
        self.f = self.path + r'/files/finished'
        self.p = self.path + r'/files/pending'
        self.c = self.path + r'/files/cookies'
        _dirs = [self.d, self.f, self.p, self.c]
        ...
        self.cookies = self._cookie_builder(self.c) or []
        self.filename = str()
        self.size = int()
    ...
    def _url_builder(self):
        ...
        urls = self._read_files(self.p)

        return urls

    def _read_files(self, pending_files):
        ...
        for _ in os.listdir(pending_files):
            _file = pending_files + '/' + _
